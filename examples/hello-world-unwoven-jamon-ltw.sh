...
java  -Dorg.aspectj.weaver.loadtime.configuration=file:config/hello-world-unwoven-aop.xml -javaagent:libs/aspectjweaver.jar -classpath libs/automon-1.0.jar:libs/helloworld_unwoven-1.0.jar:libs/helloworld_unwoven_jamon-1.0.jar:libs/jamon-2.81.jar com.stevesouza.jamon.JamonHelloWorld
# to run the program in a loop for 1000 times (allows time to look at automon jmx in jconsole)
#java  -Dorg.aspectj.weaver.loadtime.configuration=file:config/hello-world-unwoven-aop.xml -javaagent:libs/aspectjweaver.jar -classpath libs/automon-1.0.jar:libs/helloworld_unwoven-1.0.jar:libs/helloworld_unwoven_jamon-1.0.jar:libs/jamon-2.81.jar com.stevesouza.jamon.JamonHelloWorld 1000
