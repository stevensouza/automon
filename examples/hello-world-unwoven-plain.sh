...
java   -classpath ../helloworld_unwoven/target/helloworld_unwoven-1.0.jar com.stevesouza.helloworld.HelloWorld

# to run the program in a loop for 100 times (allows time to look at automon jmx in jconsole)
#java   -classpath ../helloworld_unwoven/target/helloworld_unwoven-1.0.jar com.stevesouza.helloworld.HelloWorld 100
