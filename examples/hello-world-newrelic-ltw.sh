...
# java -Dorg.automon=newrelic -Dorg.aspectj.weaver.loadtime.configuration=file:config/hello-world-unwoven-aop.xml -javaagent:libs/aspectjweaver.jar -classpath ../automon/target/automon-1.0.1.jar:../helloworld_unwoven/target/helloworld_unwoven-1.0.1.jar:libs/newrelic-api-3.29.0.jar com.stevesouza.helloworld.HelloWorld
java -Dorg.aspectj.weaver.loadtime.configuration=file:config/hello-world-unwoven-aop.xml -javaagent:libs/aspectjweaver.jar -classpath ../automon/target/automon-1.0.1.jar:../helloworld_unwoven/target/helloworld_unwoven-1.0.1.jar:libs/newrelic-api-3.29.0.jar com.stevesouza.helloworld.HelloWorld

# to run the program in a loop for 1000 times (allows time to look at automon jmx in jconsole)
# java -Dorg.aspectj.weaver.loadtime.configuration=file:config/hello-world-unwoven-aop.xml -javaagent:libs/aspectjweaver.jar -classpath ../automon/target/automon-1.0.1.jar:../helloworld_unwoven/target/helloworld_unwoven-1.0.1.jar:libs/newrelic-api-3.29.0.jar com.stevesouza.helloworld.HelloWorld 1000
