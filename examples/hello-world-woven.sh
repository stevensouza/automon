...
# java   -Dorg.automon=sysout -classpath libs/automon-1.0-SNAPSHOT.jar:libs/helloworld_woven-1.0-SNAPSHOT.jar:libs/aspectjrt.jar org.automon.helloworld.HelloWorld 100
