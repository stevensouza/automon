...
java  -Dorg.automon=statsd -Dorg.aspectj.weaver.loadtime.configuration=file:config/unwoven-jdk-aop.xml -javaagent:libs/aspectjweaver.jar -classpath ../automon/target/automon-1.0.2-SNAPSHOT.jar:../unwoven_jdk/target/unwoven_jdk-1.0.2-SNAPSHOT.jar:libs/hsqldb-2.3.2.jar:libs/java-statsd-client-3.1.0.jar com.stevesouza.jdk.JdkHelloWorld README.md
