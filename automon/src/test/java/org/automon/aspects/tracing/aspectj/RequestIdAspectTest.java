...
class RequestIdAspectTest extends TestTracingAspectBase {
    ...
    private final RequestIdAspectTest.RequestId aspect = Aspects.aspectOf(RequestIdAspectTest.RequestId.class);
    ...
    static class RequestId extends RequestIdAspect {
        ...
        @Pointcut("execution(* org.automon.aspects.tracing.aspectj.RequestIdAspectTest.MyRequestTestClass.firstName(..))")
        public void select() {
        }
