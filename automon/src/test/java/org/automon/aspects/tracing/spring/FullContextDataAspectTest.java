...
class FullContextDataAspectTest extends TestTracingAspectBase {
    ...
    static class FullContextData extends FullContextDataAspect {
        ...
        @Pointcut("execution(* org.automon.aspects.tracing.spring.FullContextDataAspectTest.MyFullContextDataTestClass.*(..)) &&" +
                "!execution(* org.automon.aspects.tracing.spring.FullContextDataAspectTest.MyFullContextDataTestClass.toString())")
        public void select() {
        }
