...
public class MetricsAnnotationsTest {
     ...
     */
    @Aspect
    static class MyMetricsTestAspect extends AutomonAspectJAspect {
        ...
        @Pointcut("within(org.automon.pointcuts.MetricsAnnotated*) && " +
