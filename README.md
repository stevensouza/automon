...
be able to start monitoring your code within minutes.  The data will be stored and displayed in the monitoring tool of your choice. The following image shows the type of data Automon collects (displayed in JAMon and here in grahphite/StatsD [Automon method and exception metrics displayed in StatsD](https://github.com/stevensouza/automon/blob/master/docs/automon_statsd.png)).
